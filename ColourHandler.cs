...
public class ColourHandler 
{
	...
	// Pretty print colour-strings
    public enum ColourRepresentations
    {
        RGB,
        Hex
    }
	...
	public struct HSV
	{
		...
		public override string  ToString() 
		{
			...
			{
				// HSV contains values scaled as in the Colour wheel:
				...
				if ( s == 0 ) 
				{
					// If s is 0, all Colours are the same.
				...
				else 
				{
					...
					// The Colour wheel consists of 6 sectors.
					...
					// Assign the fractional Colours to r, g, and b
